...
autocmd Filetype markdown inoremap <buffer> ,m - [<++>] <++><ESC>F[li
...
"autocmd Filetype markdown inoremap <buffer> ,t <ESC>:TableModeToggle<CR>i
autocmd Filetype markdown map <buffer> sf :CocCommand markdownlint.fixAll
