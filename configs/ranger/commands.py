...
class fzf_select(Command):
    ...
    def execute(self):
        ...
        if self.quantifier:
            ...
            -o -type d -print 2> /dev/null | sed 1d | cut -b3- | fzf +m --preview 'bat --style=numbers --color=always {} | head -500'"
        else:
            # match files and directories
            command="find -L . \( -path '*/\.*' -o -fstype 'dev' -o -fstype 'proc' \) -prune \
            -o -print 2> /dev/null | sed 1d | cut -b3- | fzf +m --preview 'bat --style=numbers --color=always {} | head -500'"
